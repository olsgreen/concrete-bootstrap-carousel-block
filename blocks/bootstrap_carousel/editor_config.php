...
function init_carousel_mce_editor() {
    tinyMCE.init({
        mode : "textareas",
        width: "100%", 
        ...
        if( $txtEditorMode=='CUSTOM' ){ ?>
            ...
            plugins: "inlinepopups,spellchecker,safari,advlink,advimage,xhtmlxtras,emotions,insertdatetime,paste,visualchars,nonbreaking,style",
            ...
            theme_advanced_buttons2 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent,blockquote,|,link,unlink,anchor,|,forecolor,backcolor,|,image,charmap,code",		
            theme_advanced_blockformats : "p,address,pre,h1,h2,h3,div,blockquote,cite",
            theme_advanced_fonts : "Arial=arialia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats",
